...
/*!
	...
	\param team_name a character pointer corresponding to the name of the newly
	 created team.
	\param user_id a character pointer corresponding to the name of the user
...
/*!
	...
	unique identifier corresponding to the newly created thread.
	\param user_id a character pointer corresponding to the universally
	unique identifier corresponding to of the user posting the message.
...
/*!
	...
	identifier corresponding to of the user posting the message.
...
/*!
	...
	\param user_id a character pointer corresponding to the universally unique
	identifier corresponding to of the user joining the team.
	\return On success, 1 is returned. On error, -1 is returned and errno
	is set appropriately
*/
...
/*!
	...
	identifier corresponding to the corresponding team.
	\param user_id a character pointer corresponding to the universally unique
	identifier corresponding to the user leaving the team.
	\return On success, 1 is returned. On error, -1 is returned and errno
	is set appropriately
*/
...
/*!
	...
	\param user_name a character pointer corresponding to the name
...
/*!
	...
	\param user_name a character pointer corresponding to the name of
...
/*!
	...
	unique identifier corresponding to the user receiving the message.
	\param message a character pointer corresponding to the message's content.
	\return On success, 1 is returned. On error, -1 is returned and
	errno is set appropriately
*/
