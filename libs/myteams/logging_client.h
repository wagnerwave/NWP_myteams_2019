...
/*!
	...
	\param user_id a character pointer corresponding to the universally unique
	id assigned to the user who sended the message.
...
/*!
	...
	\param team_description a character pointer corresponding to the
	team's description.
...
/*!
	\param user_id a character pointer corresponding to the
	universally unique id assigned to the user.
	\param user_name a character pointer corresponding to
	the user's name.
	\param user_status an integer corresponding to the user
...
/*!
	...
	\param channel_name a character pointer corresponding to the channel's
	name.
	\param channel_description a character pointer corresponding
...
//! Handler called when the user select a specific channel to be in
//	(/list CLI command), used in a loop over each thread
/*!
	\param thread_id a character pointer corresponding to the universally
	unique id assigned to the thread in the team.
	\param user_id a character pointer corresponding to the universally
...
//	(/list CLI command), used in a loop over each reply
/*!
	\param thread_id a character pointer corresponding to the universally
...
/*!
	\param thread_id an unsigned integer corresponding to the WRONG
	thread identifier
	\return On success, 1 is returned. On error, -1 is returned
	and errno is set appropriately
*/
...
//! Handler called when the user want to perform an action
//	that is unauthorized (not login/subscribed)
/*!
	\return On success, 1 is returned. On error, -1 is returned
	and errno is set appropriately
*/
...
//	by the server because the resource was already existing
/*!
	\return On success, 1 is returned. On error, -1 is returned
	and errno is set appropriately
*/
...
/*!
	...
	\param user_status an integer corresponding to the user status
...
/*!
	...
	\param user_id a character pointer corresponding to the universally
	unique id assigned to the user who created the thread.
	\param thread_timestamp an unsigned integer corresponding to the timestamp
	of the thread's creation.
	\param thread_title a character pointer corresponding to the thread title.
	\param thread_body a character pointer corresponding to the thread body.
	\return On success, 1 is returned. On error, -1 is returned and errno
	is set appropriately
...
/*!
	...
	unique id assigned to the team.
	\param team_name a character pointer corresponding to the team's name.
	\param team_description a character pointer corresponding
	to the team's description.
	\return On success, 1 is returned. On error, -1 is returned
	and errno is set appropriately
*/
...
/*!
	...
	\param user_id a character pointer corresponding to the universally
	unique id assigned to the user who created the thread.
	\param reply_timestamp an unsigned integer corresponding
	to the timestamp of the reply.
	\param reply_body a character pointer corresponding to the reply.
	\return On success, 1 is returned. On error, -1 is returned
	and errno is set appropriately
*/
